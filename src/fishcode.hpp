...
namespace fc
{
    ...
    public:
        ...
        FishCode(const FishCode& fish_code) = delete;
        FishCode(FishCode&& fish_code) noexcept = delete;

        FishCode& operator =(const FishCode& fish_code) = delete;
        FishCode& operator =(FishCode&& fish_code) noexcept = delete;
