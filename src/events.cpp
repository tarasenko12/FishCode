...
: wxEvent(id, fc::events::EVT_TASK_EXCEPTION),
  prompt(ex.what())
{
...
fc::events::UpdateDone::UpdateDone(int id)
...
fc::events::UpdateProgress::UpdateProgress(int id, int progress)
: wxEvent(id, fc::events::EVT_UPDATE_PROGRESS),
  progress(progress)
{
